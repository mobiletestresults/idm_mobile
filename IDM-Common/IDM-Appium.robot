...
open browser     [Arguments]        ${server_url}       ${browser} 
    Run Keyword If  '${device}'=='iPhone8Emulator'        Open Application      http://127.0.0.1:4723/wd/hub        deviceName=iPhone 8         platformName=iOS         platformVersion=14.4      browserName=${browser}      startIWDP=true      newCommandTimeout=600       xcodeSigningId=iPhone Developer     automationName=XCUITest 
    Run Keyword If  '${device}'=='iPhone8Safari'        open application	    http://127.0.0.1:4723/wd/hub        browserName=${browser}	        platformName=iOS	    deviceName=FX DMS PMO ’s iPhone		platformVersion=14.4		udid=0dc1d871a25ffcffe62eb09ea7e7649f83747968 	    xcodeOrgId=SZRB8P2RU8		newCommandTimeout=360
